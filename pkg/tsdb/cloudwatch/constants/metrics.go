...
var NamespaceMetricsMap = map[string][]string{
	...
	"AWS/ElasticTranscoder":    {"BilledAudioOutput", "BilledHDOutput", "BilledSDOutput", "Errors", "JobsCompleted", "JobsErrored", "OutputsPerJob", "StandbyTime", "Throttles"},
	...
	"AWS/MediaConvert":         {"AudioOutputSeconds", "Errors", "HDOutputDuration", "JobsCompletedCount", "JobsErroredCount", "SDOutputDuration", "StandbyTime", "TranscodingTime", "UHDOutputDuration"},
